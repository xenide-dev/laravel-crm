                    ...
                    <form>
                        ...
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(assets/media/misc/bg-1.jpg)">
                            ...
                            <h4 class="d-flex flex-center rounded-top">
                                ...
                                <span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2">2 new</span>
                            </h4>
                            <!--end::Title-->
                            <!--begin::Tabs-->
                            <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#topbar_notifications_notifications">System</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="navi navi-hover scroll my-4" data-scroll="true" data-height="300" data-mobile-height="200">
                                    ...
                                    <a href="#" class="navi-item">
                                        <div class="navi-link">
                                            ...
                                            <div class="navi-text">
                                                <div class="font-weight-bold">This section is under development</div>
                                    ...
                                    <div class="d-flex align-items-center mb-6">
                                        ...
                                        <div class="symbol symbol-40 symbol-light-primary mr-5">
                                            <span class="symbol-label">
                                                <span class="ki ki-wrench"></span>
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                        <!--begin::Text-->
                                        <div class="d-flex flex-column font-weight-bold">
                                            <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg">Oops!</a>
                                            <span class="text-muted">This section is under development</span>
                                        </div>
                                        <!--end::Text-->
                                    </div>
                                    <!--end::Item-->
            ...
            <div class="topbar-item">
                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    ...
                    <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                        <span class="symbol-label font-size-h5 font-weight-bold">{{ strtoupper(substr(Auth::user()->fname, 0, 1)) }}</span>
                    </span>
                </div>
            </div>
            <!--end::User-->
